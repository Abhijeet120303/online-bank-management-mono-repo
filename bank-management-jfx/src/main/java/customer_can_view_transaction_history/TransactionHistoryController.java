...
public class TransactionHistoryController {
  ...
  @FXML private TableColumn<Transactions, String> customerIdColumn;

  @FXML private TableColumn<Transactions, String> cardNumberColumn;

  @FXML private TableColumn<Transactions, String> transactionAmountColumn;

  @FXML private TableColumn<Transactions, String> transactionTypeColumn;

  @FXML private TableColumn<Transactions, String> dateAndTimeColumn;
  ...
  private void fetch() throws IOException, InterruptedException {
    ...
    String apiUrl =
        "http://localhost:8081/api/v1/customer/get/transactions/" + searchByCustomerId.getText();
    ...
    FilteredList<Transactions> filteredData =
        new FilteredList<>(FXCollections.observableArrayList(transactionList), p -> true);
  ...
  private void fetchTransactionData(String apiUrl) {
    try {
      List<Transactions> transaction =
          RestUtil.sendGetRequests(apiUrl, new TypeReference<List<Transactions>>() {});
