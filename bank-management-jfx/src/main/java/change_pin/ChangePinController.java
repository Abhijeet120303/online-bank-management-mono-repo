...
public class ChangePinController {
  ...
  @FXML private TextField currPin;
  @FXML private TextField newPin;
  @FXML private TextField reEnterNewPin;
  ...
  public void changePin(ActionEvent event) {
    ...
    try {
      ChangePinResponse response =
          RestUtil.sendPutRequest(
              "http://localhost:8081/auth/user/change/pin",
