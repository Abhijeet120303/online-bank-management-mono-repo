...
public class WithDrawAmountController {
  ...
  public void withdraw(ActionEvent event) {
    ...
    CustomerWithdrawAmountResponse withdrawResponse =
        performWithdraw(amount.getText(), pin.getText(), accountNumber.getText());
    ...
    if ("Success".equals(withdrawResponse.getStatus())) {
      ...
      if ("Your Account Has Lock. Please Contact The Admin"
          .equals(withdrawResponse.getResponse())) {
  ...
  private CustomerWithdrawAmountResponse performWithdraw(
      String withdrawalAmount, String pin, String accountNumber) {
  ...
  private void sendWithdrawalEmail(double amount, double availableBalance) {
    ...
    try {
      ...
      message.setText(
          "You have successfully withdrawn rupee "
              + amount
              + ". Your available balance is now rupee"
              + availableBalance);
