...
public class AdminCanEditTheCustomersController {
  ...
  @Autowired AdminCanEditTheCustomersService adminCanEditTheCustomersRepository;

  @PostMapping(path = "/auth/v1/admin/update/customer/{customerId}")
  public AdminCanEditTheCustomersResponse updateCustomer(
      @PathVariable Long customerId, @RequestBody AdminCanEditCustomerRequest request) {
